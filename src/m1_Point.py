...
class Point(object):
    ...
    def __repr__(self):
        phrase = 'Point({}, {})'.format(self.x,self.y)
        return phrase

    def clone(self):
        clone_point = Point(self.x,self.y)
        return clone_point

    def move_to(self,x,y):
        self.total_travel = self.total_travel + self.get_distance_from(Point(
            x,y))
        self.x = x
        self.y = y
    ...
    def move_by(self,dx,dy):
        self.total_travel = self.total_travel + self.get_distance_from(
    ...
    def get_distance_from_start(self):
        distance = self.get_distance_from(Point(self.startx,self.starty))
        return distance

    def get_distance_traveled(self):
        total_distance = self.total_travel
    ...
    def halfway_to(self,point2):
        average_x = (self.x+point2.x)/2
        average_y = (self.y+point2.y)/2
        new_point = Point(average_x,average_y)
        return new_point
